...
class QuranService {
  ...
  static Sura getSuraFromIndex(int index) => Sura(
    englishNames: englishSuraNames[index],
    arabicNames: arabicSuraNames[index],
  ...
  static Future<void> getMostRecentlySuras() async {
    ...
    List<String>? mostRecntlyIndexes = sharedPref.getStringList(
      'mostRecntlyIndexes',
    );
    if (mostRecntlyIndexes == null) return;
    mostRecentlySuras = mostRecntlyIndexes.map((indexString) {
  ...
  static Future<void> addSuraToMostRecently(Sura sura) async {
    ...
    if (!alreadyExist) {
      ...
      List<String> mostRecntlyIndexes = mostRecentlySuras
          .map((sura) => (sura.num - 1).toString())
          .toList();
      SharedPreferences sharedPref = await SharedPreferences.getInstance();
      sharedPref.setStringList('mostRecntlyIndexes', mostRecntlyIndexes);
    }
  }
}
